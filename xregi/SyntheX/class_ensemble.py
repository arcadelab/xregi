...
class Ensemble:
    def __init__(self, args) -> None:
        self.args = args
>>>>>>> 3a4daf29761f813530922f666c455d3df3e2367a
...
<<<<<<< HEAD
        ...
        self.test_pats = [i for i in self.args.pats.split(',')] if self.rand else [int(i) for i in self.args.pats.split(',')]
...
<<<<<<< HEAD
        ...
        test_ds = get_rand_dataset(self.src_data_file_path, self.src_label_file_path, self.test_pats, num_classes=self.num_classes, pad_img_dim=self.proj_unet_dim, no_seg=True) if self.rand else get_dataset(self.src_data_file_path, self.src_label_file_path, self.test_pats, num_classes=self.num_classes, pad_img_dim=self.proj_unet_dim, no_seg=True, valid=True)
        ...
        seg_dataset_ensemble(test_ds, self.nets, f, dev=self.dev, num_lands=self.num_lands, times=times, adv_loss=False)
