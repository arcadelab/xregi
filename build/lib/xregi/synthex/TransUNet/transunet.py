...
class VisionTransformer(nn.Module):
    def __init__(
        ...
        if self.num_lands > 0:
            ...
            lands_1x1.append(
                nn.Conv2d(
                    lands_block_num_chan + n_classes,
            ...
            for i in range(lands_num_1x1 - 1):
                lands_1x1.append(
                    nn.Conv2d(
                        lands_1x1_num_out_feat, num_lands, kernel_size=1, bias=False
                    )
                )
...
class VisionTransformerAdv(nn.Module):
    def __init__(
        ...
        self.conv_landmarks_adv = nn.Conv2d(16, num_lands, kernel_size=1, bias=True)
